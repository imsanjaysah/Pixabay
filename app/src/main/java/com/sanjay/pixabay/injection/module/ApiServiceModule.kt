...
import com.sanjay.pixabay.data.api.HeaderInterceptor
import com.sanjay.pixabay.data.api.PixabayService
import com.sanjay.pixabay.extensions.isConnected
...
open class ApiServiceModule {
    ...
    internal fun provideHttpClient(
        ...
        httpInterceptor: HttpLoggingInterceptor, app: PixabayApplication
    ): OkHttpClient {
    ...
    @Provides
    @Singleton
    open fun provideService(retrofit: Retrofit): PixabayService {
